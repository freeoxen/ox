...
function renderPreamble(raw: string): string {
  ...
  <section class="hero hero-brand-hero">
    <div class="hero-brand">ox<span style="font-size:.2em;vertical-align:2.5em;margin-left:.15em">tm</span></div>
...
function renderSection03(raw: string): string {
  ...
  if (brandSub) {
    ...
    inner += `      <div class="brand-title-demo"><span class="brand-title-ox">ox<span style="font-size:.2em;vertical-align:2.5em;margin-left:.15em">tm</span></span> <span class="brand-title-desc">playground</span></div>\n`;
...
${body}
  <footer class="site-footer">
    <span class="footer-brand">ox<span style="font-size:.2em;vertical-align:2.5em;margin-left:.15em">tm</span></span>
