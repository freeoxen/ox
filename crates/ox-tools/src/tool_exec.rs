//! JSON-in/JSON-out entry point shared by the installed tool executor binaries.
//!
...
/// Run the tool executor process, including sandbox re-execution and JSON I/O.
///
/// This entry point may exit the process on invalid invocation or input.
pub fn main() {
